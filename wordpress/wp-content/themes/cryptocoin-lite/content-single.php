   ...
   <div class="blogin-bx"> 
    <header class="entry-header">        
           <div class="blog-postmeta">
			 <?php if( get_theme_mod( 'cryptocoin_lite_hide_postdate_fromsingle' ) == '') { ?> 
                  <div class="post-date"> <i class="far fa-clock"></i>  <?php echo esc_html( get_the_date() ); ?></div><!-- post-date --> 
                <?php } ?> 
                
                <?php if( get_theme_mod( 'cryptocoin_lite_hide_postcats_fromsingle' ) == '') { ?> 
    ...
    <footer class="entry-meta">
      <?php edit_post_link( __( 'Edit', 'cryptocoin-lite' ), '<span class="edit-link">', '</span>' ); ?>
    </footer><!-- .entry-meta -->
    </div><!-- .blogin-bx--> 
 </article>
</div><!-- .BlogPosts-List-->