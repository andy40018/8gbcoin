...
/**
 * Class cryptoairdrop_Customize_Radio_Buttonset_Control
 */
class cryptoairdrop_Customize_Radio_Buttonset_Control extends cryptoairdrop_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-radio-buttonset';
