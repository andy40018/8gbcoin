...
/**
 * Class cryptoairdrop_Customize_Color_Control
 */
class cryptoairdrop_Customize_Color_Control extends cryptoairdrop_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-color';
