 ...
 */
class cryptoairdrop_Customize_Recommended_Plugin_Section extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-plugin-section';
	 ...
	 * @var    string
	 */
	public $cryptoairdrop_plugin_url = '';
