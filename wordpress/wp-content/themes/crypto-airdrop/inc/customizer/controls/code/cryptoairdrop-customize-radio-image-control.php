...
/**
 * Class cryptoairdrop_Customize_Radio_Image_Control
 */
class cryptoairdrop_Customize_Radio_Image_Control extends cryptoairdrop_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-radio-image';
