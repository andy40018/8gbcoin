...
/**
 * Class cryptoairdrop_Customize_Slider_Control
 */
class cryptoairdrop_Customize_Slider_Control extends cryptoairdrop_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-slider';
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="cryptoairdrop-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="cryptoairdrop-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'crypto-airdrop' ); ?></span></span>
			</div>
		</div>
