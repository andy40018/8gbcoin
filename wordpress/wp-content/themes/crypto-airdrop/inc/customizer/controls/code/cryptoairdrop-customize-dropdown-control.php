...
/**
 * Class cryptoairdrop_Customize_Dropdown_Control
 */
class cryptoairdrop_Customize_Dropdown_Control extends WP_Customize_Control {
	...
	public function render_content(){
		...
		// Set defaults
		$this->defaults = array(
			'show_option_none' => __( 'None','crypto-airdrop' ),
			'orderby'          => 'name',
			'hide_empty'       => 0,
			'id'               => $this->id,
			'selected'         => $this->value(),
