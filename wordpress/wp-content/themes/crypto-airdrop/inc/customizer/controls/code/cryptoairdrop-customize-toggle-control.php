...
/**
 * Class cryptoairdrop_Customize_Toggle_Control
 */
class cryptoairdrop_Customize_Toggle_Control extends cryptoairdrop_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'cryptoairdrop-toggle';
