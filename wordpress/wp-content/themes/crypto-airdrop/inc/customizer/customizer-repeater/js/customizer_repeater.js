...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-cryptoairdrop_docs_content')
		{
			var numItems = jQuery("#customize-control-cryptoairdrop_docs_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 4){ 
			  jQuery( "#customize-control-cryptoairdrop_docs_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}
        
		if(parentid == 'customize-control-cryptoairdrop_roadmap_content')
		{
			var numItems = jQuery("#customize-control-cryptoairdrop_roadmap_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 5){ 
			   jQuery( "#customize-control-cryptoairdrop_roadmap_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var docs_items = jQuery("#customize-control-cryptoairdrop_docs_content .customizer-repeater-general-control-repeater-container").length 
				if(docs_items < 5){
				  jQuery( "#customize-control-cryptoairdrop_docs_upgrade .cryptoairdrop-upgrade-pro-message" ).hide(); 
				}
				var roadmap_items = jQuery("#customize-control-cryptoairdrop_roadmap_content .customizer-repeater-general-control-repeater-container").length 
				if(roadmap_items < 6){
				  jQuery( "#customize-control-cryptoairdrop_roadmap_upgrade .cryptoairdrop-upgrade-pro-message" ).hide();  
				}
