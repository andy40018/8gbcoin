 ...
 */
 $cryptoairdrop_footer_widgets_container = get_theme_mod('cryptoairdrop_footer_container_size', 'container');
?>
<!-- Footer Widget -->
    <?php if (is_active_sidebar('footer_widget_area_left') || is_active_sidebar('footer_widget_area_center') ||  is_active_sidebar('footer_widget_area_right')) : ?>
        <footer id="footer" class="footer">
            <div class="border-box">
                <div class="<?php echo esc_attr($cryptoairdrop_footer_widgets_container); ?> site-footer">    
                    <div class="row">
                        <div class="col-md-4">
